...
contract PayrollImplementation is Initializable, EIP712Upgradeable {
    address public hr;
    address public director;
    address public priceFeed;
    string public departmentName;

    bytes32 public constant PAYSTUB_TYPEHASH = keccak256("PayStub(address employee,uint256 period,uint256 usdAmount)");
